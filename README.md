...
Put mp2ktool in the same directory as gba-song-assembler, or set a path to it using `--mp2ktool_path`, in order to have gba-song-assembler automatically get the correct sound table address.  
You can get a ready-to-run copy of mp2ktool by downloading [my fork of GBA_Mus_Ripper](https://github.com/Thysbelon/gba-mus-ripper).

To make MP2K song s files, I recommend using [Midi2AGB](https://github.com/Thysbelon/midi2agb) (originally written by [ipatix](https://github.com/ipatix/midi2agb)) to convert midi files to s files.    
